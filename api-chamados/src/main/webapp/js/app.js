...
appEntra21.config(function($routeProvider, $locationProvider){
	...
	$routeProvider
    .when("/chamados",{templateUrl:'view/chamado-insert.html', controller:'chamadoController'})
    .when("/chamados-listar",{templateUrl:'view/chamado.html', controller:'chamadoController'})
